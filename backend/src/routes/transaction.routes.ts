...
router.post("/", roleMiddleware(['SUPERADMIN']), transactionController.createTransaction.bind(transactionController)); // Only SUPERADMIN can manually create transactions
router.post("/contribute", transactionController.contribute.bind(transactionController)); // Members (incl admin) make own payments
