...
router.post("/", validate(createGroupSchema), controller.createGroup.bind(controller));
...
router.put("/:id", requireAdminRole, validate(updateGroupSchema), controller.updateGroup.bind(controller));
